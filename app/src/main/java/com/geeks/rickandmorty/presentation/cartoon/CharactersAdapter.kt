...
class CharactersAdapter(
    ...
    class VH(private val b: ItemCharacterBinding) : RecyclerView.ViewHolder(b.root) {
        fun bind(item: Character, onItemClick: (Character) -> Unit) {
            ...
            b.characterStatus.text = "Status: ${item.status}"
            b.characterSpecies.text = "Species: ${item.species}"
            b.characterGender.text = "Gender: ${item.gender}"
            b.characterOrigin.text = "Origin: ${item.origin.name}"
            b.characterLocation.text = "Location: ${item.location.name}"
            b.characterEpisodes.text = "Episodes: ${item.episode.size}"
